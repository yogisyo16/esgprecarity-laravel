...
@section('content')
    <div class="flex flex-col justify-center items-center gap-6 max-w-auto transition-opacity opacity-100 duration-750 starting:opacity-0 md:items-center md:gap-5">
        <div class="flex flex-col justify-between items-between gap-4 md:flex-row md:w-4/6">
            <div class="flex flex-col justify-center items-center gap-2 m-6 md:items-start md:m-0">
                ...
                <ul class="font-arvo mt-4 mx-6 ">
                    ...
                    <li class="list-disc list-inside">{{ __('messages.survey_condition_5') }}</li>
                </ul>
            </div>
            <div class="hidden items-center gap-2 md:items-center md:flex">
                <img src="/images/rethink-image.png" alt="{{ __('messages.survey_title') }}" class="w-auto">
            </div>
        </div>
