...
@push('language')
    <details class="dropdown">
        <summary class="btn btn-outline flex-wrap w-26 pb-10 md:w-auto md:pb-0 mr-6 md:mr-4">
            {{ __('messages.language_title') }}: {{ __('messages.language') }} <img src="{{ __('messages.flag_languages') }}" alt="" class="hidden md:block w-12">
        </summary>
        <ul class="menu dropdown-content bg-base-100 rounded-box z-1 w-30 md:w-40 p-2 shadow-sm" data-theme="dark">
            <li>
                <a href="{{ route('set.language', 'en') }}">
                    <img src="images/flag_england.png" alt="" class="hidden md:block w-12">
                    English
                </a>
            </li>
            <li>
                <a href="{{ route('set.language', 'id') }}">
                    <img src="images/flag_indonesia.png" alt="" class="hidden md:block w-12">
                    Indonesia
                </a>
            </li>
        </ul>
