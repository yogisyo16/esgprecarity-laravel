        ...
        <form method="POST" action="{{ route('saveYesInvestmentData') }}" class="container flex flex-col font-arvo items-center">
            ...
            <div class="join flex flex-col my-2 p-2 gap-4 md:flex-row md:gap-20">
                <div class="radio-container flex flex-row items-center bg-green-700 rounded-full p-4 md:flex-col cursor-pointer">
                    <label class="flex flex-row items-center p-1.5 gap-2.5 aspect-square rounded-full w-full h-full cursor-pointer">
                        $400
                        <input type="radio" name="nominal_answer" value="$400" class="radio checked:bg-black invisible" 
                ...
                <div class="radio-container flex flex-row items-center bg-green-700 rounded-full p-4 md:flex-col cursor-pointer">
                    <label class="flex flex-row items-center p-1.5 gap-2.5 aspect-square rounded-full w-full h-full cursor-pointer">
                        $380
                        <input type="radio" name="nominal_answer" value="$380" class="radio checked:bg-black invisible" 
                ...
                <div class="radio-container flex flex-row items-center bg-green-700 rounded-full p-4 md:flex-col cursor-pointer">
                    <label class="flex flex-row items-center p-1.5 gap-2.5 aspect-square rounded-full w-full h-full cursor-pointer">
                        $350
                        <input type="radio" name="nominal_answer" value="$350" class="radio checked:bg-black invisible" 
            ...
            <div class="join flex flex-col my-2 p-2 gap-4 md:flex-row md:gap-20">
                <div class="radio-container flex flex-row items-center bg-green-700 rounded-full p-4 md:flex-col cursor-pointer">
                    <label class="flex flex-row items-center p-1.5 gap-2.5 aspect-square rounded-full w-full h-full cursor-pointer">
                        $320
                        <input type="radio" name="nominal_answer" value="$320" class="radio checked:bg-black invisible" 
                ...
                <div class="radio-container flex flex-row items-center bg-green-700 rounded-full p-4 md:flex-col cursor-pointer">
                    <label class="flex flex-row items-center p-1.5 gap-2.5 aspect-square rounded-full w-full h-full cursor-pointer">
                        $300
                        <input type="radio" name="nominal_answer" value="$300" class="radio checked:bg-black invisible" 
